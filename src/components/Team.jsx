...
const TeamMemberCard = ({ member, delay }) => (
  <div data-animate style={{ animationDelay: `${delay}s` }} className="text-center">
    <div className="relative inline-block mb-4 group">
      <img
        src={member.imageUrl}
        alt={member.name}
        className="w-40 h-40 rounded-full object-cover border-4 border-gray-800 transition-all duration-300 group-hover:border-red-500/50"
      />
      <div className="absolute inset-0 rounded-full border-2 border-transparent group-hover:border-red-500 transition-all duration-300 scale-100 group-hover:scale-110"></div>
    </div>
  ...
  return (
    <section id="team" className="py-20 md:py-32 bg-transparent">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p data-animate className="text-center max-w-3xl mx-auto text-gray-300 text-lg mt-8 mb-16">
          The driving force behind our club. A group of dedicated and passionate individuals committed to our collective success.
        </p>
